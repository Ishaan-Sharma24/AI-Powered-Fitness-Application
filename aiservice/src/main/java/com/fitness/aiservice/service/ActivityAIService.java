...
//            log.info("RESPONSE FROM CLEANED AI {}", jsonContent);
            ...
            List<String> improvements =extractImporvements(analysisJson.path("imporvements"));
    ...
    private Recommendation createDefaultRecommendation(Activity activity) {
        return Recommendation.builder()
                ...
                .safety(Arrays.asList(
                        "Always warm up before exercize",
                        "Stay hydrated",
                        "Listen to your body"
    ...
    private List<String> extractImporvements(JsonNode improvementsNode) {
